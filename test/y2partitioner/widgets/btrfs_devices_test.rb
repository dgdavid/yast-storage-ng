  ...
  describe "#validate" do
    ...
    RSpec.shared_examples "raid levels validations" do
      ...
      context "DUP" do
        ...
        context "but there is more than once device selected" do
          before do
            controller.add_device(dev("/dev/sda3"))
      ...
      context "RAID10" do
        ...
        context "and there are less than five devices selected" do
          before do
            controller.add_device(dev("/dev/sda3"))
            controller.add_device(dev("/dev/sde3"))
        ...
        context "and there are at least five devices selected" do
          before do
            controller.add_device(dev("/dev/sda3"))
            controller.add_device(dev("/dev/sde3"))
            controller.add_device(dev("/dev/sdf"))
        ...
        context "and there are more than five devices selected" do
          before do
            controller.add_device(dev("/dev/sda3"))
            controller.add_device(dev("/dev/sde3"))
            controller.add_device(dev("/dev/sdf"))
        ...
        context "and there are at least three devices selected" do
          before do
          end
